...
if (isset($_REQUEST['addpayment'])) {
	...
	include "conn.php";
	$addpay = "INSERT INTO payment(cid, mode, net, paid, due, status, pdate, ptime) VALUES('$cid', '$paymode', '$paynet', '$paypaid', '$paydue', '$paystatus', '$dd1', '$tt')";
	  	...
	  	<div class="container-fluid">
	    	...
	    	<div class="collapse navbar-collapse" id="navbarSupportedContent">
	      		...
	      		<form class="d-flex" method="POST" role="search">
	        		<button type="submit" name="cancel" class="btn btn-danger">Cancel Bill</button>	 
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     
				</form>
	    	</div>
	  	</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8 p-3">
					<center>
						<h1 class="text-white"><font size="15"><u>Generate Invoice</u></font></h1>
					</center>
				</div>
				<div class="col-md-2"></div>
			</div>
			<div class="col-md-12 bg-primary tab-container">
				<div class="btab" style="height: 500px;overflow-y: scroll;overflow-x: scroll;">
					...
					<div class="row">
						<div class="col-md-5">
							<h3 class="text-white">Generate Invoice</h3>
						</div>
						<div class="col-md-5">
							<h3 class="text-white">Net-Amount : <?php echo $sum; ?></h3>
						</div>
						<div class="col-md-2">
	      	...
	      	<div class="modal-body">
	        	<form class="row g-3" method="POST">
		        	...
		        	<div class="col-md-6">
				    	...
				    	<input type="text" class="form-control" id="paynet" name="paynet" value="<?php echo $sum; ?>" required>
				  	</div>
				 	<div class="col-md-6">
				    	<label for="paypaid" class="form-label">Paid Amount*</label>
				    	<input type="text" class="form-control" id="paypaid" name="paypaid" placeholder="Paid Amount" onkeyup="getdue();" required>
				  	</div>
				  	<div class="col-md-6 mb-3">
				    	<label for="paydue" class="form-label">Due Amount</label>
				    	<input type="text" class="form-control" id="paydue" name="paydue" placeholder="Due Amount">
				  	</div>
				  	<div class="col-md-6 mb-3">
				    	<label for="paystatus" class="form-label">Payment Status</label>
				    	<input type="text" class="form-control" id="paystatus" name="paystatus" placeholder="Payment Status">
				  	</div>
	      	</div>
	      	<div class="modal-footer">
	        	<button type="submit" name="addpayment" class="btn btn-primary">Generate Invoice</button>
		    </div>
	  			</form>
	    </div>
	  </div>
